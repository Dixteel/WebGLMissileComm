...
export class AssetLoader {
  constructor() {
		this.ASSET = {
			ball: { url: "res/sprite0.png" },
			indicator: { url: "res/Indicator.png", },
			missile: { url: "res/missile.png" }
		};
	}
	...
	LoadAsset(callback) {
		...
		for (var property in this.ASSET) {
			if (this.ASSET.hasOwnProperty(property)) {
				loadCounter ++;
				textureLoader.load( this.ASSET[property].url, _setupAsset(ASSET[property], callBack));
			}
		}
	}
